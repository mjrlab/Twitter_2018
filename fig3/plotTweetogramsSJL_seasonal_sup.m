%2018-08-05, EL: make sup figs showing seasonal changes for example counties
%2018-06-27, EL: Fig. 3
...
%% save Fig. 3A-B?
expif(TOEXP,fOne,'tgram_feb','OUTDIR',['exTgrams/' whichCounty],...
    'fun2use','expfig','ext','pdf');
expif(TOEXP,fTwo,'tgram_aug','OUTDIR',['exTgrams/' whichCounty],...
    'fun2use','expfig','ext','pdf');
...
fTroughs = figure('units','inches','position',[0 0 2 1.5],'color','w');
monthLabels = {'Jan','','Mar','','May','','July','','Sep','','Nov',''};
plot(1:12,wkdayTr,'sk-','markersize',2,'linewidth',lineWidth,...
    'DisplayName','weekday');
hold on;
plot(1:12,wkendTr,'sc-','markersize',2,'linewidth',lineWidth,...
    'DisplayName','weekend');
fixAxesTroughs(gca);
expif(TOEXP,fTroughs,'troughsEx','OUTDIR',['exTgrams/' whichCounty],...
    'fun2use','expfig','ext','pdf');
...
set(hAx,'xlim',[24 48],'xtick',0:6:48,'xticklabels',(0:6:48)-24,...
    'ytick',0:0.01:0.02,'yticklabels',[],'fontsize',8);
    %'yticklabels',4*[0:0.01:0.02],'fontsize',8);
...
text(1.5,6.5,'weekend','color','c','fontsize',8,...
    'VerticalAlignment','top','HorizontalAlignment','left');

set(hAx,'xlim',[1 12],'xtick',1:12,'xticklabels',monthLabels,...
    'ylim',[3.5 7],'ytick',hrTimes,'yticklabels',[],'fontsize',8);
    %'yticklabels',hrLabels,'fontsize',8);
